...
func (p *kClient) Login(ctx context.Context, req *user.UserRequest) (r *user.UserResponse, err error) {
...
func (p *kClient) Register(ctx context.Context, req *user.UserRequest) (r *user.UserResponse, err error) {
